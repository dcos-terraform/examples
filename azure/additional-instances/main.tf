...
module "addinst" {
  ...
  resource_group_name       = module.dcos.infrastructure_resource_group_name
  subnet_id                 = module.dcos.infrastructure_subnet_id
  network_security_group_id = module.dcos.infrastructure_private_agents_nsg_id
  admin_username            = module.dcos.infrastructure_private_agents_admin_username
