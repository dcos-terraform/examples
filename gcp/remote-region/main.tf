...
module "dcos" {
  ...
  additional_private_agent_ips = concat(
    module.dcos-use1.private_agents_private_ips,
    module.dcos-use4.private_agents_private_ips,
  )
}
...
module "network-connection-master-use1" {
  ...
  local_network_self_link  = module.dcos.infrastructure_network_self_link
